...
class YOLO(object):
    _defaults = {
        "model_path": 'logs/001/trained_weights_transfer_1.h5', #'model_data/yolo_face_weights.h5',
...
#         self.image_name = os.path.expanduser(self.image_name) #shjeong added
    ...
    def _get_class(self):
        ...
        print("length of classes: ", len(class_names))   # added by me
        return class_names
    ...
    def detect_image(self, image, imgname):
        ...
        print(image_data.shape)    # using weights in Quick Start: (416, 416, 3)
        image_data /= 255.
...
# #             # My kingdom for a good redistributable image drawing library.
        ...
        if len(out_boxes)>0:
            image.save('/home/shjeong/yolo-codes-keras/inference_result/001/'+imgname)
